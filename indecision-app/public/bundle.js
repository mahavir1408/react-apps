...
var IndecisionApp = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function componentDidMount() {
      try {
        var json = sessionStorage.getItem('options');
...
var Options = function Options(props) {
  ...
  }, "Remove all"), props.options.length === 0 && /*#__PURE__*/React.createElement("p", null, "Please add an options to get started!"), props.options.map(function (option) {
