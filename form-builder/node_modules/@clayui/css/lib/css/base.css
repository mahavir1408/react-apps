...
.clay-color-dropdown-menu {
  ...
  .clay-color-dropdown-menu .component-action:focus, .clay-color-dropdown-menu .component-action.focus {
    box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25);
    color: #000; }
  .clay-color-dropdown-menu .component-action:active:focus, .clay-color-dropdown-menu .component-action.active:focus,
...
.previous-month-date {
  ...
  .previous-month-date:focus, .previous-month-date.focus {
    opacity: 1; }
  .previous-month-date:active, .previous-month-date.active,
...
.next-month-date {
  ...
  .next-month-date:focus, .next-month-date.focus {
    opacity: 1; }
  .next-month-date:active, .next-month-date.active,
