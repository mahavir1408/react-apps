...
.btn-monospaced.btn-sm, .btn-group-sm .btn-monospaced {
  height: 2rem;
...
.alert-primary {
  ...
  .alert-primary .alert-btn {
    ...
    .alert-primary .alert-btn:hover {
      ...
      border-color: #0b5fff;
      color: #fff; }
    .alert-primary .alert-btn:active, .alert-primary .alert-btn.active,
...
.alert-secondary {
  ...
  .alert-secondary .alert-btn {
    ...
    .alert-secondary .alert-btn:hover {
      ...
      border-color: #6b6c7e;
      color: #fff; }
    .alert-secondary .alert-btn:active, .alert-secondary .alert-btn.active,
...
.alert-success {
  ...
  .alert-success .alert-btn {
    ...
    .alert-success .alert-btn:hover {
      ...
      border-color: #287d3c;
      color: #fff; }
    .alert-success .alert-btn:active, .alert-success .alert-btn.active,
...
.alert-info {
  ...
  .alert-info .alert-btn {
    ...
    .alert-info .alert-btn:hover {
      ...
      border-color: #2e5aac;
      color: #fff; }
    .alert-info .alert-btn:active, .alert-info .alert-btn.active,
...
.alert-warning {
  ...
  .alert-warning .alert-btn {
    ...
    .alert-warning .alert-btn:hover {
      ...
      border-color: #b95000;
      color: #fff; }
    .alert-warning .alert-btn:active, .alert-warning .alert-btn.active,
...
.alert-danger {
  ...
  .alert-danger .alert-btn {
    ...
    .alert-danger .alert-btn:hover {
      ...
      border-color: #da1414;
      color: #fff; }
    .alert-danger .alert-btn:active, .alert-danger .alert-btn.active,
...
.alert-light {
  ...
  .alert-light .alert-btn {
    ...
    .alert-light .alert-btn:hover {
      ...
      border-color: #272833;
      color: #fff; }
    .alert-light .alert-btn:active, .alert-light .alert-btn.active,
...
.alert-dark {
  ...
  .alert-dark .alert-btn {
    ...
    .alert-dark .alert-btn:hover {
      ...
      border-color: #272833;
      color: #fff; }
    .alert-dark .alert-btn:active, .alert-dark .alert-btn.active,
...
.clay-color-btn {
  ...
  padding-top: 0;
  width: 1.5rem; }
  .clay-color-btn:active, .clay-color-btn.active,
...
.clay-color-pointer {
  ...
  .clay-color-pointer:focus, .clay-color-pointer.focus {
    ...
    outline: 0; }
  .clay-color-pointer:active:focus, .clay-color-pointer.active:focus,
...
.clay-time .btn {
  ...
  .clay-time .btn:active:focus, .clay-time .btn.active:focus,
...
.date-picker-nav {
  ...
  .date-picker-nav .nav-btn {
    ...
    .date-picker-nav .nav-btn:focus, .date-picker-nav .nav-btn.focus {
      ...
      box-shadow: 0 0 0 0.125rem #fff, 0 0 0 0.25rem #80acff;
      color: #272833; }
    .date-picker-nav .nav-btn:active, .date-picker-nav .nav-btn.active,
    .show > .date-picker-nav .nav-btn.dropdown-toggle {
      background-color: #f1f2f5; }
      .date-picker-nav .nav-btn:active:focus, .date-picker-nav .nav-btn.active:focus,
...
.date-picker-date {
  ...
  .date-picker-date:focus, .date-picker-date.focus {
    ...
    color: #272833;
    outline: 0; }
  .date-picker-date:active, .date-picker-date.active,
  .show > .date-picker-date.dropdown-toggle {
    background-color: #0b5fff;
    color: #fff; }
    .date-picker-date:active:focus, .date-picker-date.active:focus,
...
.nav-link.btn-unstyled {
  ...
  .nav-link.btn-unstyled:focus, .nav-link.btn-unstyled.focus {
    box-shadow: 0 0 0 0.125rem #fff, 0 0 0 0.25rem #80acff; }
  .nav-link.btn-unstyled:active:focus, .nav-link.btn-unstyled.active:focus,
...
.nav-tabs {
  ...
  .nav-tabs .nav-link {
    ...
    .nav-tabs .nav-link:active {
      ...
      color: #272833; }
    .show > .nav-tabs .nav-link, .nav-tabs .nav-link.active {
      background-color: #fff;
      border-color: transparent transparent #f1f2f5;
      color: #272833; }
  ...
  @media (max-width: 767.98px) {
    .menubar-vertical-expand-md.menubar-transparent .menubar-toggler {
      ...
      .menubar-vertical-expand-md.menubar-transparent .menubar-toggler:focus, .menubar-vertical-expand-md.menubar-transparent .menubar-toggler.focus {
        box-shadow: 0 0 0 0.125rem #fff, 0 0 0 0.25rem #80acff;
        outline: 0; }
      .menubar-vertical-expand-md.menubar-transparent .menubar-toggler:active:focus, .menubar-vertical-expand-md.menubar-transparent .menubar-toggler.active:focus,
  ...
  @media (max-width: 991.98px) {
    .menubar-vertical-expand-lg.menubar-transparent .menubar-toggler {
      ...
      .menubar-vertical-expand-lg.menubar-transparent .menubar-toggler:focus, .menubar-vertical-expand-lg.menubar-transparent .menubar-toggler.focus {
        box-shadow: 0 0 0 0.125rem #fff, 0 0 0 0.25rem #80acff;
        outline: 0; }
      .menubar-vertical-expand-lg.menubar-transparent .menubar-toggler:active:focus, .menubar-vertical-expand-lg.menubar-transparent .menubar-toggler.active:focus,
...
.sidebar-dark {
  ...
  .sidebar-dark .nav-nested .nav-link {
    ...
    .sidebar-dark .nav-nested .nav-link:active {
      color: #fff; }
    .show > .sidebar-dark .nav-nested .nav-link, .sidebar-dark .nav-nested .nav-link.active {
      color: #fff; }
...
.tbar-stacked {
  ...
  .tbar-stacked .tbar-btn-monospaced {
    ...
    .tbar-stacked .tbar-btn-monospaced:focus, .tbar-stacked .tbar-btn-monospaced.focus {
      box-shadow: inset 0 0 0 0.125rem #80acff, inset 0 0 0 0.25rem #fff; }
    .tbar-stacked .tbar-btn-monospaced:active:focus, .tbar-stacked .tbar-btn-monospaced.active:focus,
...
.tbar-light {
  ...
  .tbar-light .tbar-btn-monospaced:focus, .tbar-light .tbar-btn-monospaced.focus {
    color: #272833; }
  .tbar-light .tbar-btn-monospaced:active, .tbar-light .tbar-btn-monospaced.active,
...
.tbar-dark-l2 {
  ...
  .tbar-dark-l2 .tbar-btn-monospaced:focus, .tbar-dark-l2 .tbar-btn-monospaced.focus {
    color: #fff; }
  .tbar-dark-l2 .tbar-btn-monospaced:active, .tbar-dark-l2 .tbar-btn-monospaced.active,
...
.tbar-dark-d1 {
  ...
  .tbar-dark-d1 .tbar-btn-monospaced:focus, .tbar-dark-d1 .tbar-btn-monospaced.focus {
    color: #fff; }
  .tbar-dark-d1 .tbar-btn-monospaced:active, .tbar-dark-d1 .tbar-btn-monospaced.active,
